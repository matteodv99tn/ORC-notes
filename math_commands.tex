% ENVIRONMENTS FOR EQUATIONS
\newenvironment{eqs*}{\begin{equation*}\aligned}{\endaligned\end{equation*}}
\newenvironment{eqs}[1]{\equation\label{#1}\aligned}{\endaligned\endequation}
